...
# ════════════════════════════════════════════════════════════
# PAGE 5 — ANTENNA DESIGN
# ════════════════════════════════════════════════════════════
elif page == "📡 Antenna Design":
    ...
    try:
        st.image(os.path.join(BASE_DIR, '../antenna_design_images/antenna_3d.png'),
    ...
    with col1:
        try:
            st.image(os.path.join(BASE_DIR, '../antenna_design_images/s11_graph.png'),
    ...
    with col1:
        try:
            st.image(os.path.join(BASE_DIR, '../antenna_design_images/radiation_pattern_2d.png'),
    ...
    with col2:
        try:
            st.image(os.path.join(BASE_DIR, '../antenna_design_images/radiation_pattern_3d.png'),
    ...
    with col1:
        try:
            st.image(os.path.join(BASE_DIR, '../antenna_design_images/efield.png'),
