...
fig.suptitle('Experiment 2 - ML Model Performance\n'
...
plt.tight_layout()
plt.savefig('../results/ml_results_400.png', dpi=150, bbox_inches='tight')
plt.show()
print("\nPlot saved as results/ml_results_400.png")